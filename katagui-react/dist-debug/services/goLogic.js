 ...
 */
export function getAdjacentPoints(point, boardSize) {
    const { row, col } = point;
    const adjacent = [];
    if (row > 0)
 ...
 */
export function getGroup(board, point, boardSize) {
 ...
 */
export function countLiberties(board, group, boardSize) {
 ...
 */
export function findAndRemoveCaptures(board, lastMove, currentPlayer, boardSize) {
 ...
 */
export function isSelfCapture(board, point, currentPlayer, boardSize) {
 ...
 */
export function applyMove(board, point, currentPlayer, boardSize) {
    const key = pointToKey(point);
...
//# sourceMappingURL=goLogic.js.map